...
<div class="container mx-auto px-4 py-8">
    ...
    <div class="bg-white rounded-lg shadow-lg p-6"> <!-- Début de la carte -->
        ...
        <form action="<?php echo e(route('games.update', $game->id)); ?>" method="POST" class="max-w-lg mx-auto" enctype="multipart/form-data">
            <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>" 
                       value="<?php echo e(old('name', $game->name)); ?>" required>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="mb-4">
                ...
                <input type="text" name="genre" id="genre" 
                       class="w-full border rounded px-3 py-2 <?php $__errorArgs = ['genre'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" 
                       value="<?php echo e(old('genre', $game->genre)); ?>" required>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="mb-4">
                ...
                <input type="date" name="release_date" id="release_date" 
                       class="w-full border rounded px-3 py-2 <?php $__errorArgs = ['release_date'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" 
                       value="<?php echo e(old('release_date', $game->release_date)); ?>" required>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="mb-4">
                ...
                <input type="text" name="developer" id="developer" 
                       class="w-full border rounded px-3 py-2 <?php $__errorArgs = ['developer'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" 
                       value="<?php echo e(old('developer', $game->developer)); ?>" required>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="mb-4">
                ...
                <input type="text" name="publisher" id="publisher" 
                       class="w-full border rounded px-3 py-2 <?php $__errorArgs = ['publisher'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" 
                       value="<?php echo e(old('publisher', $game->publisher)); ?>" required>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="mb-4">
                ...
                <input type="text" name="platform" id="platform" 
                       class="w-full border rounded px-3 py-2 <?php $__errorArgs = ['platform'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" 
                       value="<?php echo e(old('platform', $game->platform)); ?>" required>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="mb-4">
                ...
                <input type="file" name="image_url" id="image_url" 
                       class="w-full border rounded px-3 py-2 <?php $__errorArgs = ['image_url'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                <?php if($game->image_url): ?>
                    <div class="mt-2">
                        <img src="<?php echo e($game->image_url); ?>" alt="Image actuelle" class="w-32 h-32 object-cover">
...
unset($__errorArgs, $__bag); ?>" 
                          rows="4" required><?php echo e(old('description', $game->description)); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="mt-6 border-t pt-4 text-center"> <!-- Séparateur pour les commentaires -->
            <a href="<?php echo e(route('comments.index', ['game_id' => $game->id])); ?>" 
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/resources/views/games/edit.blade.php ENDPATH**/ ?>