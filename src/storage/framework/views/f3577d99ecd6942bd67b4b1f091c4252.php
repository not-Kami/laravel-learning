...
<div class="container mx-auto px-4">
    ...
    <form action="<?php echo e(route('games.store')); ?>" method="POST" class="max-w-lg" enctype="multipart/form-data">
        <?php echo csrf_field(); ?>
        <div class="mb-4">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/resources/views/games/create.blade.php ENDPATH**/ ?>